  ...
  return (
    ...
    <div className="App">
      ...
      <div className="video-container">
        <Webcam ref={webcamref} style={{width: '40%', borderRadius: '15px'}}/>
        <canvas ref={canvasref}>
        </canvas>
        <p> {msg} </p>
        <div class="robot" onMouseover={() => setMsg('Need some help? Click me!')} onMouseLeave={() => setMsg('')} onClick={clicked}><svg version="1.1" xmlns="http://www.w3.org/2000/svg" >
	<g id="hover">
