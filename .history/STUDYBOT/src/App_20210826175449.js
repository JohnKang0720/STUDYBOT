    ...
    <div>
        ...
        <div className="modal-frame">
          ...
          <div className="modal-info">
            <div className="modal-text">
              <h1 style={{ margin: '40px' }}> Edit Todo {todos.id}</h1>
      ...
      {todos.length === 0 ? <p> Add your todos! </p> :
        <ul className="todo-container">
          {todos.map(({ id, todo }) => {
            return <li> {todo} <button className="add" onClick={e => db.collection('todos').doc(id).delete()}> Delete </button> <button className="add" onClick={() => setOpen(!open)}> Edit </button></li>
          })}
        </ul>}
    </div>
  )
...
//   const [open, setOpen, todos] = props.state
//   const [edit, setEdit] = useState('')
...
//           <div className="modal-info">
//             <div className="modal-text">
//               <h1 style={{ margin: '40px' }}> Edit Todo {id}</h1>
//               <input placeholder="Edit your todo..." onChange={e => setEdit(e.target.value)} />
//               <button className="add" onClick={handleUpdate}> Update </button>
//             </div>
//             <div className="modal-image">
