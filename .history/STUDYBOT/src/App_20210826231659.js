    ...
    <div className="App">
        ...
        <div className="commands">
          <div className="command-list">
            <p> <strong> Bot Commands: </strong>
              ...
              <li> "Task" -- Number of tasks you have left </li>
      ...
      <div className="container">
        <div className="video-container">
          <p> Bad posture duration: {count}s</p>
          <Webcam ref={webcamref} style={{ width: '60%', borderRadius: '15px' }} />
          <canvas ref={canvasref}>
          </canvas>

          <TodoList info={[setTodo]} due={[duedate, setdueDate]} />
...
function TodoList(props) {
  ...
  const [duedate, setdueDate] = props.due
  ...
  const handleAdd = () => {
    if (input !== '') {
      ...
      setdueDate([...duedate, db.collection('todos').get('due')])
      console.log("DUE: " + db.collection('todos').get('due'))
    }
  }
