...
class Timer extends React.Component {
    ...
    componentDidUpdate(){
        this.props.counts(this.state.rounds)
    }
    ...
    render() {
        return (
            <div className="timer-inner">
                <p style={{ fontSize: '2rem', background: 'orange', margin: '5px', borderRadius: '10px' }}> Todays' high Score: {localStorage.getItem('hightime2')} </p>
