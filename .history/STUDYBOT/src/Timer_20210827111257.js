    ...
    render() {
        return (
            <div className="timer-inner">
                <p style={{ fontSize: '2rem', background: 'orange', margin: '5px', borderRadius: '10px' }}> Todays' high Score: {localStorage.getItem('highscore')} rounds, {localStorage.getItem('hightime')}m : {localStorage.getItem('hightime2')}s </p>
