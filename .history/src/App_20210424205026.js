...
//integrate water, stretching, theme
  ...
  return (
    <div className="App">
     <Webcam ref = {webcamref} style = {{position: "absolute", marginLeft: "-300px", marginTop: "500px"}}/> 
     <canvas ref = {canvasref} style = {{position: "absolute", marginLeft: "-300px", width: "640px", height: "480px", marginTop: "500px"}}> 
